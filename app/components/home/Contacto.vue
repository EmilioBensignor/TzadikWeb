<template>
    <DefaultSection class="md:px-11 md:pb-12 lg:px-20 lg:pb-0">
        <div class="w-full max-w-[1200px] flex flex-col items-center md:items-start gap-3 md:gap-4 bg-gradient-to-r from-dark to-primary bg-contacto bg-cover bg-center bg-no-repeat md:rounded-[32px] md:shadow-lg py-6 px-5 md:p-8 lg:p-10 xxl:p-12">
