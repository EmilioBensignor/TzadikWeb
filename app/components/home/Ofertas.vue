<template>
    <DefaultSection class="py-8 md:py-12 md:px-11">
        ...
        <CarouselStatic :slides-per-view="{ base: 1.4, sm: 3.1, md: 3, lg: 3, xl: 4, xxl: 4 }" :gap="{ base: 12, lg: 16, xl: 16, xxl: 16 }" class="pl-1">
