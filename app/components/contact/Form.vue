    ...
    <Teleport to="body">
        <Transition enter-active-class="transition-all duration-300 ease-out"
            ...
            <div v-if="isOpen && !showConfirmation"
                class="flex items-center justify-center fixed inset-0 z-[9999] bg-dark/60 p-5" @click="closeModal">
        ...
        <Transition enter-active-class="transition-all duration-300 ease-out"
            leave-active-class="transition-all duration-200 ease-in" enter-from-class="opacity-0"
            enter-to-class="opacity-100" leave-from-class="opacity-100" leave-to-class="opacity-0">
            <div v-if="showConfirmation" class="flex items-center justify-center fixed inset-0 z-[9999] bg-dark/60 p-4"
