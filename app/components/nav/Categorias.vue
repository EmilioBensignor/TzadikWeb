<template>
    <div
        class="lg:w-[62rem] xxl:w-[64rem] lg:sticky lg:top-[9.5rem] xxl:top-36 lg:z-50 bg-light lg:rounded-full shadow-md lg:primary-shadow py-2 lg:py-3 lg:px-12 lg:-mt-52 xxl:-mt-60 lg:mx-auto">
